                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" style="text-transform:uppercase;" id="persona" name="persona" value="<?php echo $_GET['persona']; ?>" placeholder="FECHA">
                                                </div>
...
<?php
    ...
    if (isset($_GET['persona'])) {
        $arr_result = getGiroFecha($_GET['persona']);
        ...
        <script>
            function buscaPersona() {
                ...
                if (persona !== null && persona !== '') {
                    urlGET = "http://10.168.196.152/sistema_kera/pages/giro_busca_fec.php?persona=" + persona;
                } else {
                    urlGET = "http://10.168.196.152/sistema_kera/pages/giro_busca_fec.php";
                }
